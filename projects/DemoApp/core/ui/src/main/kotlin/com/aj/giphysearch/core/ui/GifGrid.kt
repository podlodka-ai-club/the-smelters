...
fun GifGrid(
    ...
    LazyVerticalStaggeredGrid(
        ...
        state = gridState,
        modifier = modifier.testTag("gif_grid"),
    ...
    LaunchedEffect(gridState, lazyPagingItems) {
        ...
        snapshotFlow { gridState.layoutInfo }
            .collect { layoutInfo ->
                ...
                android.util.Log.d("PrefetchTest", "layoutInfo collected, visible items: ${visibleItems.size}, itemCount: ${lazyPagingItems.itemCount}")
                if (visibleItems.isNotEmpty()) {
                    ...
                    for (i in start until end) {
                        // Use .get(i) instead of .peek(i) to trigger Paging 3 prefetching
